...
model{
  ...
  elr[2] ~ lognormal(-0.30664185, 0.000005);
  elr[3] ~ lognormal(-0.33387318, 0.000005);
  elr[4] ~ lognormal(-0.31547302, 0.001);
  elr[5] ~ lognormal(-0.21780273, 0.008);
  elr[6] ~ lognormal(-0.16347435, 0.025);
  elr[7] ~ lognormal(-0.38046764, 0.035);
  elr[8] ~ lognormal(-0.24165823, 0.05);
  elr[9] ~ lognormal(-0.35168867, 0.08);
  elr[10] ~ lognormal(-0.33063526, 0.08);
  elr[11] ~ lognormal(-0.330663526, 0.08);
