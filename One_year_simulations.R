...
clusterExport(c1, 't')
tic()
cc <- parSapply(c1,1:10000,function(p) next_year_obligations(arranged_sets,diagonal,1,1.01,future_best_estimates))
toc()
stopCluster(c1)
#
hist(cc, col ='orange')
...
>>>>>>> b99be8a99e08baef93684f2117b1c1eb4111ab8f
