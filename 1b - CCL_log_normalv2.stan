...
model{
  ...
  elr[2] ~ lognormal(-0.30664554, 0.000005);
  elr[3] ~ lognormal(-0.33359792, 0.000005);
  elr[4] ~ lognormal(-0.31752852, 0.001);
  elr[5] ~ lognormal(-0.21770283, 0.008);
  elr[6] ~ lognormal(-0.16445022, 0.025);
  elr[7] ~ lognormal(-0.38036773, 0.035);
  elr[8] ~ lognormal(-0.24155832, 0.05);
  elr[9] ~ lognormal(-0.35158876, 0.08);
  elr[10] ~ lognormal(-0.33053536, 0.08);
  elr[11] ~ lognormal(-0.30313638, 0.085);
